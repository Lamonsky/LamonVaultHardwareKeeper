...
{
    public class NewNetworkDeviceTypeViewModel : JedenViewModel<NewNetworkDeviceTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.NETWORKDEVICETYPE, HttpMethod.Post, item, null);
