...
{
    public class NewManufacturerViewModel : JedenViewModel<NewManufacturerCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.MANUFACTURER, HttpMethod.Post, item, null);
