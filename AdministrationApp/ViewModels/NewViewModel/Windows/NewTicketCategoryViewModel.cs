...
{
    public class NewTicketCategoryViewModel : JedenViewModel<NewTicketCategoryCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.TICKETCATEGORY, HttpMethod.Post, item, null);
