...
{
    public class NewMonitorModelViewModel : JedenViewModel<NewMonitorModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.MONITORMODEL, HttpMethod.Post, item, null);
