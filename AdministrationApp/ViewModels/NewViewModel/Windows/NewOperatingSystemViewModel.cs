...
{
    public class NewOperatingSystemViewModel : JedenViewModel<NewOperatingSystemCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.OPERATINGSYSTEM, HttpMethod.Post, item, null);
