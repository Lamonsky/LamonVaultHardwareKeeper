...
{
    public class NewDeviceTypeViewModel : JedenViewModel<NewDeviceTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.DEVICETYPE, HttpMethod.Post, item, null);
