...
{
    public class NewComputerTypeViewModel : JedenViewModel<NewComputerTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.COMPUTERTYPE, HttpMethod.Post, item, null);
