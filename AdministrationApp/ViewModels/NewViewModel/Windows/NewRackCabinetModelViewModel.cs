...
{
    public class NewRackCabinetModelViewModel : JedenViewModel<NewRackCabinetModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.RACKCABINETMODEL, HttpMethod.Post, item, null);
