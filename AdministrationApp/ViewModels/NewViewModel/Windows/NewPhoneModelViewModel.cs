...
{
    public class NewPhoneModelViewModel : JedenWindowViewModel<PhoneModelCreateEditVM>
    {
        ...
        public override async void Save()
        {
            ...
            NewSaveLogs(item);
            await RequestHelper.SendRequestAsync(URLs.PHONEMODEL, HttpMethod.Post, item, GlobalData.AccessToken);
