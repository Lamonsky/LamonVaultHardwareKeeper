...
{
    public class NewPhoneModelViewModel : JedenViewModel<NewPhoneModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.PHONEMODEL, HttpMethod.Post, item, null);
