...
{
    public class NewMonitorTypeViewModel : JedenViewModel<NewMonitorTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.MONITORTYPE, HttpMethod.Post, item, null);
