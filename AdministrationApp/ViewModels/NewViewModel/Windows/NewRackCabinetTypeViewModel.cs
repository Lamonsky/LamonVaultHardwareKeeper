...
{
    public class NewRackCabinetTypeViewModel : JedenViewModel<NewRackCabinetTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.RACKCABINETTYPE, HttpMethod.Post, item, null);
