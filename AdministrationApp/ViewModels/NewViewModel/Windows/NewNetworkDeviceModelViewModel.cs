...
{
    public class NewNetworkDeviceModelViewModel : JedenViewModel<NewNetworkDeviceModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.NETWORKDEVICEMODEL, HttpMethod.Post, item, null);
