...
{
    public class NewDeviceModelViewModel : JedenViewModel<NewDeviceModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.DEVICEMODEL, HttpMethod.Post, item, null);
