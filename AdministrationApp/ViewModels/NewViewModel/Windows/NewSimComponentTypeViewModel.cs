...
{
    public class NewSimComponentTypeViewModel : JedenViewModel<NewSimComponentTypeCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.SIMCOMPONENTTYPE, HttpMethod.Post, item, null);
