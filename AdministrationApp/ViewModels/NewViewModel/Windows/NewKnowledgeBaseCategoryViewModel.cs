...
namespace AdministrationApp.ViewModels.NewViewModel.Windows
{
    public class NewKnowledgeBaseCategoryViewModel : JedenViewModel<NewKnowledgeBaseCategoryCreateEditVM>
    {
        ...
        #region Konstruktor
        public NewKnowledgeBaseCategoryViewModel(Window window) : base("KnowledgeBaseCategory")
        {
            item = new KnowledgeBaseCategoryCreateEditVM();
            _window = window;
        }
        public override async void Save()
        {
            await RequestHelper.SendRequestAsync(URLs.KNOWLEDGEBASECATEGORY, HttpMethod.Post, item, null);
