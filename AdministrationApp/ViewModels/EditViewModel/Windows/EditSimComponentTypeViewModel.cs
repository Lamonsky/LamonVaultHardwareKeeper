...
{
    public class EditSimComponentTypeViewModel : JedenWindowViewModel<SimComponentTypeCreateEditVM>
    {
        ...
        public override async void Save()
        {
            ...
            await RequestHelper.SendRequestAsync(URLs.SIMCOMPONENTTYPE_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, GlobalData.AccessToken);
