...
{
    public class EditPrintertypeViewModel : JedenViewModel<PrinterTypeCreateEditVM>
    {
        ...
        #region Konstruktor
        public EditPrintertypeViewModel(Window window, PrinterTypeCreateEditVM vm) : base("Printertype")
        {
            item = vm;
            _window = window;
            setForeignKeys();
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.PRINTERTYPE_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, null);
