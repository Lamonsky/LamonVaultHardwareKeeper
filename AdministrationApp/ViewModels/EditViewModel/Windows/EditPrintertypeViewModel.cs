...
{
    public class EditPrintertypeViewModel : JedenWindowViewModel<PrinterTypeCreateEditVM>
    {
        ...
        #region Konstruktor
        public EditPrintertypeViewModel(Window window, PrinterTypeCreateEditVM vm) : base("Edycja rodzaju drukarki")
        {
            item = vm;
            oldItem = vm;
            _window = window;
