...
{
    public class EditNetworkDevicemodelViewModel : JedenViewModel<NetworkDeviceModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.NETWORKDEVICEMODEL_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, null);
