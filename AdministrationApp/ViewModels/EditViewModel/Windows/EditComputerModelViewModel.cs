...
{
    public class EditComputerModelViewModel : JedenWindowViewModel<ComputerModelCreateEditVM>
    {
        ...
        #region Konstruktor
        public EditComputerModelViewModel(Window window, ComputerModelCreateEditVM vm) : base("Edycja modelu komputera")
        {
            item = vm;
            oldItem = vm;
            _window = window;
