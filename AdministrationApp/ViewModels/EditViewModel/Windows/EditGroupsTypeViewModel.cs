...
{
    public class EditGroupsTypeViewModel : JedenViewModel<GroupTypeCreateEditVM>
    {
        ...
        #region Konstruktor
        public EditGroupsTypeViewModel(Window window, GroupTypeCreateEditVM vm) : base("GroupsType")
        {
            item = vm;
            _window = window;
            setForeignKeys();
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.GROUPTYPE_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, null);
