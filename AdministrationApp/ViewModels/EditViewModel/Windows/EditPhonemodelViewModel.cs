...
{
    public class EditPhonemodelViewModel : JedenViewModel<PhoneModelCreateEditVM>
    {
        ...
        {
            await RequestHelper.SendRequestAsync(URLs.PHONEMODEL_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, null);
