...
{
    public class EditPositionViewModel : JedenWindowViewModel<PositionCreateEditVM>
    {
        ...
        public override async void Save()
        {
            ...
            await RequestHelper.SendRequestAsync(URLs.POSITION_ID.Replace("{id}", item.Id.ToString()), HttpMethod.Put, item, GlobalData.AccessToken);
