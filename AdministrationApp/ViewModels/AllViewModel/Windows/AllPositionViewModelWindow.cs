...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllPositionViewModelWindow : WszystkieViewModel<PositionVM>
    {
        ...
        {
            List = await RequestHelper.SendRequestAsync<object, List<PositionVM>>(URLs.POSITION, HttpMethod.Get, null, GlobalData.AccessToken);
        }

        public async override void Remove()
        {

            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.POSITION_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
