...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllHardDriveModelViewModelWindow : WszystkieViewModel<HardDriveModelVM>
    {
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.HARDDRIVEMODEL_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
