...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllMonitorTypeViewModelWindow : WszystkieViewModel<MonitorTypeVM>
    {
        ...
        public AllMonitorTypeViewModelWindow(Window window) : base("Rodzaje monitorów")
        {
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.MONITORTYPE_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
