...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllNetworkDeviceTypeViewModelWindow : WszystkieViewModel<NetworkDeviceTypeVM>
    {
        ...
        public override void Filter()
        {
            ...
            {
                default:
                    List = new List<NetworkDeviceTypeVM>(
                        List.Where(item =>
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.NETWORKDEVICETYPE_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
