...
{
    class AllSimCardViewModelWindow2 : WszystkieViewModel<SimCardsVM2>
    {
        private Window _window;
        public AllSimCardViewModelWindow2() : base("Karty SIM")
        {
            Messenger.Default.Register<string>(this, open);
        }
        public AllSimCardViewModelWindow2(Window window) : base("Karty SIM")
        {
            Messenger.Default.Register<string>(this, open);
            _window = window;
        }
        ...
        {
            List = await RequestHelper.SendRequestAsync<object, List<SimCardsVM2>>(URLs.SIMCARD, HttpMethod.Get, null, GlobalData.AccessToken);
        }
        ...
        public override async void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.SIMCARD_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
