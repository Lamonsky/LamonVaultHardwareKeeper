...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllRackCabinetModelViewModelWindow : WszystkieViewModel<RackCabinetModelVM>
    {
        ...
        public override void Filter()
        {
            ...
            {
                default:
                    List = new List<RackCabinetModelVM>(
                        List.Where(item =>
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.RACKCABINETMODEL_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
