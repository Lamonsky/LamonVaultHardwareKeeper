...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllOperatingSystemViewModelWindow : WszystkieViewModel<OperatingSystemVM>
    {
        ...
        public override void Filter()
        {
            ...
            {
                default:
                    List = new List<OperatingSystemVM>(
                        List.Where(item =>
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.OPERATINGSYSTEM_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
