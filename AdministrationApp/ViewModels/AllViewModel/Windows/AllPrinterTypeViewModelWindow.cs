...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllPrinterTypeViewModelWindow : WszystkieViewModel<PrinterTypeVM>
    {
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.PRINTERTYPE_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
