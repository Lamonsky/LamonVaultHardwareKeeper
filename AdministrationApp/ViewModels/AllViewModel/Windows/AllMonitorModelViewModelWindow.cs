...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllMonitorModelViewModelWindow : WszystkieViewModel<MonitorModelVM>
    {
        ...
        {
            List = await RequestHelper.SendRequestAsync<object, List<MonitorModelVM>>(URLs.MONITORMODEL, HttpMethod.Get, null, GlobalData.AccessToken);
        }

        public async override void Remove()
        {

            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.MONITORMODEL_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
