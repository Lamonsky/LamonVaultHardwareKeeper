...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllDeviceModelViewModelWindow : WszystkieViewModel<DeviceModelVM>
    {
        ...
        public AllDeviceModelViewModelWindow(Window window) : base("Modele urz¹dzeñ")
        {
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.DEVICEMODEL_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
