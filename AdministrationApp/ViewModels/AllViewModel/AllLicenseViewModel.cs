...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllLicenseViewModel : WszystkieViewModel<LicenseVM>
    {
        ...
        public async override void Remove()
        {
            ...
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.LICENSE_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
