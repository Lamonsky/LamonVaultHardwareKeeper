...
namespace AdministrationApp.ViewModels.AllViewModel
{
    class AllNetworkDeviceViewModel : WszystkieViewModel<NetworkDeviceVM>
    {
        ...
        {
            if (ChosenItem != null) await RequestHelper.SendRequestAsync(URLs.NETWORKDEVICE_ID.Replace("{id}", ChosenItem.Id.ToString()), HttpMethod.Delete, ChosenItem, GlobalData.AccessToken);
            load();
        }
